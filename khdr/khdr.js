...
function changeIcon(ye) {
  ...
  // ores dew leaves
  else if (ye.includes("Crafting Material 1") || ye.includes("Copper Ore") || ye.includes("Starry Sand") || ye.includes("Serenity Shard") || ye.includes("Iron Ore") || ye.includes("Burnt Coal") || ye.includes("Power Shard") || ye.includes("Twilight Shard") || ye.includes("Energy Shard") || ye.includes("Bright Shard") || ye.includes("Mythril Shard") || ye.includes("Scorching Sand")) {
    ret = "./img/ore.png"
  } else if (ye.includes("Crafting Material 2") || ye.includes("White Flower Dew") || ye.includes("White Flower Nectar") || ye.includes("Mythril Stone") || ye.includes("Writhing Stone") || ye.includes("Betwixt Stone") || ye.includes("Stormy Stone")) {
    ret = "./img/dew.png"
  } else if (ye.includes("Crafting Material 3") || ye.includes("Strange Leaf") || ye.includes("Strange Bulb")) {
    ret = "./img/leaf.png"
  }
  // events
  else if (ye.includes("Candy Earrings")) {
    ret = "./img/candy-earrings.png"
  } else if (ye.includes("Candy Crown")) {
    ret = "./img/candy-crown.png"
  } else if (ye.includes("Pumpkin Band")) {
    ret = "./img/pumpkin-band.png"
  } else if (ye.includes("Spider Web Badge")) {
    ret = "./img/spider-web-badge.png"
  }
  return ret
};
