...
async function tourneyList(type) {
    ...
    if (type === "all") {
        ...
        if (document.querySelector('input[name="btnradio2"]:checked').id.replace('btnradio', '') === "Allv") {
            ...
            if (data.length === 0) {
                tourneyList.innerHTML = "<h5 style='text-align: center'>No Tournaments Found</h5>"
            };
            data = data.sort((a, b) => a.tourney_id - b.tourney_id);
            for (var i = 0; i < data.length; i++) {
                let tourney = bigTourney[data[i].tourney_id];
...
async function loadTourneyData(year, one, two) {
        ...
        for (var i in phaseData) {
            ...
            <div class="d-flex py-3">
                <div class="whoIs player align-items-center">
                    <div class="playerData" style="text-align: center">
    ...
    <div class="d-flex justify-content-start" style="max-height: 583px" id="mainTourneyContent">
...
async function loadPlayer(id) {
    ...
    */
    ...
    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                                ...
                                <li class="nav-item px-4">
                                    ...
                                    <div>
                                        <img src="e2f8f101328a4b4ae7875945716345b3.svg" style="width: 30px; height: 30px;" draggable="false"><span class="pr-10"><text id="1v1_1">${tops[0][0]}</text></span>
                                        <img src="c65da98dd1cd29756d4d5901ed549661.svg" style="width: 30px; height: 30px;" draggable="false"><span class="pr-10"><text id="1v1_2">${tops[0][1]}</text></span>
                                        <img src="9ecf90770f4de9be7b44cb601d49722c.svg" style="width: 30px; height: 30px;" draggable="false"><span class="pr-10"><text id="1v1_3">${tops[0][2]}</text></span>
                                    </div>
                                ...
                                <li class="nav-item px-4">
                                    ...
                                    <div>
                                        <img src="e2f8f101328a4b4ae7875945716345b3.svg" style="width: 30px; height: 30px;" draggable="false"><span class="pr-10"><text id="2v2_1">${tops[1][0]}</text></span>
                                        <img src="c65da98dd1cd29756d4d5901ed549661.svg" style="width: 30px; height: 30px;" draggable="false"><span class="pr-10"><text id="2v2_2">${tops[1][1]}</text></span>
                                        <img src="9ecf90770f4de9be7b44cb601d49722c.svg" style="width: 30px; height: 30px;" draggable="false"><span class="pr-10"><text id="2v2_3">${tops[1][2]}</text></span>
                                    </div>
        ...
        <nav class="flex-column flex-md-center justify-content-between navbar navbar-expand-sm bg${isDark} navbar${isDark}" style="border-radius: 0 0 15px 15px ">
            <div class="d-flex justify-content-center">
                <div>
                    <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                        <li class="nav-item px-4">
        ...
        <div>
            <div>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menuC" aria-labelledby="dropdownMenuButton">
                        ...
                        <input type="radio" class="btn-check" name="btnradio2" id="btnradio2v3" autocomplete="off">
                        <label class="btn btn-outline-primary" for="btnradio2v3">Other Tournaments</label>
                    </ul>
                </div>
                <div class="btn-group">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menuC" aria-labelledby="dropdownMenuButton">
                        <input type="radio" class="btn-check" name="btnradio3" id="btnradioAllt" autocomplete="off" checked>
                        <label class="btn btn-outline-success" for="btnradioAllt">Both</label>

                        <input type="radio" class="btn-check" name="btnradio3" id="btnradioOffi" autocomplete="off">
                        <label class="btn btn-outline-success" for="btnradioOffi">Officials</label>

                        <input type="radio" class="btn-check" name="btnradio3" id="btnradioComm" autocomplete="off">
                        <label class="btn btn-outline-success" for="btnradioComm">Communities</label>
                    </ul>
                </div>
            </div>
            <div class="ms-auto" style="overflow: auto; max-width:693px; height: 786px; padding-top: 10 !important;" id="tourneyList">
                meow meow
            </div>
        </div>
    </div>`
...
async function loadOther(id) {
    ...
    Last 3 Tournament Placements (split official & community)
    Players Teamed With
    */

    var playResu = document.getElementsByClassName('playerResults');
    let img = "";
    if (currentPlay.images.length !== 0 && currentPlay.images.some(x => x.type.toLowerCase() == "profile")) {
    ...
    for (var i in currentPlay.tourneys) {
        ...
        for (var t = 0; t < currentPlay.tourneys[i].length; t++) {
            for (var r = 0; r < currentPlay.tourneys[i][t].length; r++) {
                ...
                if (currentPlay.tourneys[i][t][r].data.main.placement <= 32) {
                    tops[t][4]++;
    ...
    for (var i = 0; i < charStages.legends.length; i++) {
        ...
        for (var d = 0; d < charStages.legends[i].opponents.length; d++) {
            ...
            <div class="col" style="padding: unset; width: unset">
                <div class="row g-0" style="width: 170px">
                    ...
                    <div class="col-md-8 me-2" style="width: unset">
                        <div class="card-body" style="padding:unset">
                            ...
                            <p style="color: #7ab15b; margin:unset;">${charStages.legends[i].opponents[d].winsAgainst} W<text style="opacity: 0%">  •  </text><text style="color: #ff677c; margin:unset;">${charStages.legends[i].opponents[d].lossAgainst} L</p>
                        </div>
                    </div>
                </div>
            </div>`
        ...
        characterDiv += `
        <div class="col" style="padding: unset; width: 456.25px">
            <div class="card">
                <div class="row g-0">
                    <div class="col-md-4 me-2" style="width: unset">
                    ...
                    <div>
                        ...
                        <div id="opponents" class="row row-cols-1 row-cols-md-2 d-flex justify-content-around" style="overflow: auto; height: 177px; --bs-gutter-x:0rem; padding-top: 10 !important">
                            ${opponents}
                        </div>
                </div>
                </div>
    ...
    <br>
    <div class="d-flex" style="height: 681px;">
        <div>
            <div style="text-align: center">
                <div>
                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group" style="display: inline">
                        ...
                        <input type="radio" class="btn-check" name="btnradioStats" id="btnradioTeam" autocomplete="off">
                        <label class="btn btn-outline-warning" for="btnradioTeam">2v2 / Teammate History</label>

                        <input type="radio" class="btn-check" name="btnradioStats" id="btnradioOther" autocomplete="off">
                        <label class="btn btn-outline-warning" for="btnradioOther">Other Statistics</label>
                    </div>
                </div>
            </div>
            <div id="otherTab" style="width:1840px;">
                <div>
...
async function changeOtherStats(type) {
    ...
    otherTab.innerHTML = `<div style="width:1840px"><h1 style="text-align: center">loading . . .</h1></div>`
    if (type === "Chars") {
        let charStages = getAllCharStages(currentPlay.id);
        let characterDiv = `<div class="row row-cols-1 row-cols-md-2 d-flex justify-content-between" style="overflow: auto; --bs-gutter-x:0rem; padding-top: 10 !important">`;
        for (var i = 0; i < charStages.legends.length; i++) {
        ...
        async function historyFunc() {
            if (currentSortedHistory.length !== 0) {
                ...
                for (var i in playerHistory) {
                    let player = await fetch(`https://saorax.github.io/pl/${playerHistory[i].smashId}.json`, {
                        "headers": {
                            "accept": "*/*",
                            "accept-language": "en-US,en;q=0.9",
                            "sec-ch-ua": "\" Not A;Brand\";v=\"99\", \"Chromium\";v=\"98\", \"Opera GX\";v=\"84\"",
                    ...
                    if (isOffline === true) {
                        player = await fetch(`http://localhost:3000/main.php?type=user&user=${playerHistory[i].smashId}`, {
                            "method": "GET",
                        }).then(res => res.json()).catch(err => {
                            console.log(err);
                        });
                    ...
                    let setWins = [0, 0];
                    let setLose = [0, 0];
                    for (var d = 0; d < playerHistory[i].officials.loss.tourneys.length; d++) {
                        let set = playerHistory[i].officials.loss.tourneys[d].setInfo;
                        let slotFilter1 = set.slots.filter(u => u.standing.entrant.participants[0].user.id === player.id)[0];
                        let slotFilter2 = set.slots.filter(u => u.standing.entrant.participants[0].user.id !== player.id)[0];
                        setWins[0] += slotFilter2.standing.stats.score.value;
                        setLose[0] += slotFilter1.standing.stats.score.value
                    };
                    for (var d = 0; d < playerHistory[i].officials.wins.tourneys.length; d++) {
                        let set = playerHistory[i].officials.wins.tourneys[d].setInfo;
                        let slotFilter1 = set.slots.filter(u => u.standing.entrant.participants[0].user.id === player.id)[0];
                        let slotFilter2 = set.slots.filter(u => u.standing.entrant.participants[0].user.id !== player.id)[0];
                        setWins[0] += slotFilter2.standing.stats.score.value;
                        setLose[0] += slotFilter1.standing.stats.score.value
                    };
                    for (var d = 0; d < playerHistory[i].community.loss.tourneys.length; d++) {
                        let set = playerHistory[i].community.loss.tourneys[d].setInfo;
                        let slotFilter1 = set.slots.filter(u => u.standing.entrant.participants[0].user.id === player.id)[0];
                        let slotFilter2 = set.slots.filter(u => u.standing.entrant.participants[0].user.id !== player.id)[0];
                        setWins[1] += slotFilter2.standing.stats.score.value;
                        setLose[1] += slotFilter1.standing.stats.score.value
                    };
                    for (var d = 0; d < playerHistory[i].community.wins.tourneys.length; d++) {
                        let set = playerHistory[i].community.wins.tourneys[d].setInfo;
                        let slotFilter1 = set.slots.filter(u => u.standing.entrant.participants[0].user.id === player.id)[0];
                        let slotFilter2 = set.slots.filter(u => u.standing.entrant.participants[0].user.id !== player.id)[0];
                        setWins[1] += slotFilter2.standing.stats.score.value;
                        setLose[1] += slotFilter1.standing.stats.score.value
                    ...
                    tempSorted.push({
                        smashId: playerHistory[i].smashId,
                        officials: {
                            games: playerHistory[i].officials.games,
                            wins: playerHistory[i].officials.wins,
                            loss: playerHistory[i].officials.loss,
                            setWins: setWins[0],
                            setLoss: setLose[0]
                        },
                        community: {
                            games: playerHistory[i].community.games,
                            wins: playerHistory[i].community.wins,
                            loss: playerHistory[i].community.loss,
                            setWins: setWins[1],
                            setLoss: setLose[1]
                        },
                        playerInfo: {
                        ...
                        totalGames: playerHistory[i].officials.games + playerHistory[i].community.games
                    })
                };
                        ...
                        <div class="d-flex">
                            ...
                            <div class="ms-auto mb-2">
                                <div class="btn-group" style="height:100%">
                                    ...
                                    <ul class="dropdown-menu dropdown-menuC" aria-labelledby="dropdownMenuButton">
                                        <input type="radio" class="btn-check" name="btnradioPlFilter" id="btnradioOffi" autocomplete="off" checked="">
                                        <label class="btn btn-outline-primary" for="btnradioOffi">Officials</label>
                                        <input type="radio" class="btn-check" name="btnradioPlFilter" id="btnradioComm" autocomplete="off">
                                        <label class="btn btn-outline-primary" for="btnradioComm">Communities</label>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    if (combinedArray.games !== null) {
        ...
        for (var i = 0; i < combinedArray.games.length; i++) {
            ...
            if (combinedArray.games[i].stage !== null) {
                stage = `<div class="col"><h4>Game ${i+1}</h4>${combinedArray.games[i].stage.name}</div>`
            } else {
                stage = `<div class="col"><h4>Game ${i+1}</h4>No Stage</div>`
            };
            // change this entire shit
            if (combinedArray.games[i].selections !== null) {
                ...
                if (self.seed.seedNum > opponent.seed.seedNum) {
                    if (combinedArray.games[i].winnerId === combinedArray.playerId && combinedArray.playerId === self.standing.entrant.id) {
                        selfSet += `<div class="col"><h4 style="color: #7ab15b">${selfChar}<text style="opacity: 0">•</text>W</h4></div>`;
                        oppSet += `<div class="col"><h4 style="color: #d62c43">L<text style="opacity: 0">•</text>${oppChar}</h4></div>`;
                    } else if (combinedArray.games[i].winnerId === combinedArray.playerId && combinedArray.playerId !== self.standing.entrant.id) {
                        oppSet += `<div class="col"><h4 style="color: #7ab15b">W<text style="opacity: 0">•</text>${oppChar}</h4></div>`;
                        selfSet += `<div class="col"><h4 style="color: #d62c43">${selfChar}<text style="opacity: 0">•</text>L</h4></div>`;
                    } else if (combinedArray.games[i].winnerId !== combinedArray.playerId && combinedArray.playerId === self.standing.entrant.id) {
                        oppSet += `<div class="col"><h4 style="color: #7ab15b">W<text style="opacity: 0">•</text>${oppChar}</h4></div>`;
                ...
                if (self.seed.seedNum > opponent.seed.seedNum) {
                    if (combinedArray.games[i].winnerId === combinedArray.playerId && combinedArray.playerId === self.standing.entrant.id) {
                        selfSet += `<div class="col"><h4 style="color: #7ab15b">W</h4></div>`;
                        oppSet += `<div class="col"><h4 style="color: #d62c43">L</h4></div>`;
                    } else if (combinedArray.games[i].winnerId === combinedArray.playerId && combinedArray.winner !== self.standing.entrant.id) {
                        oppSet += `<div class="col"><h4 style="color: #7ab15b">W</h4></div>`;
                        selfSet += `<div class="col"><h4 style="color: #d62c43">L</h4></div>`;
                    } else if (combinedArray.games[i].winnerId !== combinedArray.playerId && combinedArray.playerId === self.standing.entrant.id) {
                        oppSet += `<div class="col"><h4 style="color: #7ab15b">W</h4></div>`;
    ...
    if (type === "Change1") {
        ...
        for (var i = 0; i < upsets.length; i++) {
            ...
            if (curTourn[1] === 1) {
                ...
                for (var g = 0; g < tempImg.length; g++) {
                    if (g === 0) {
                        temImg += `<div class="EntrantScore__icon"><div class="Player__avatar-container">`
                    }
                    if (tempImg[g].letter !== true) {
                        temImg += `
                        <div class="Player__avatar profile-thumb" aria-label="${tempImg[g].name}">
